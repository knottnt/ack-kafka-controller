...
// +kubebuilder:rbac:groups=kafka.services.k8s.aws,resources=topics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kafka.services.k8s.aws,resources=topics/status,verbs=get;update;patch
