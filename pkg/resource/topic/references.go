...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForClusterARN(ctx, apiReader, ko); err != nil {
...
func validateReferenceFields(ko *svcapitypes.Topic) error {
	...
	if ko.Spec.ClusterRef != nil && ko.Spec.ClusterARN != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("ClusterARN", "ClusterRef")
	}
	if ko.Spec.ClusterRef == nil && ko.Spec.ClusterARN == nil {
		return ackerr.ResourceReferenceOrIDRequiredFor("ClusterARN", "ClusterRef")
	}
	return nil
}

// resolveReferenceForClusterARN reads the resource referenced
// from ClusterRef field and sets the ClusterARN
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForClusterARN(
	ctx context.Context,
	apiReader client.Reader,
	...
	if ko.Spec.ClusterRef != nil && ko.Spec.ClusterRef.From != nil {
		...
		ko.Spec.ClusterARN = (*string)(obj.Status.ACKResourceMetadata.ARN)
	}
