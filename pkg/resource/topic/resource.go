...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f0, f0ok := identifier.AdditionalKeys["clusterARN"]
	if f0ok {
		r.ko.Spec.ClusterARN = aws.String(f0)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f0, ok := fields["clusterARN"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: clusterARN"))
	}
	r.ko.Spec.ClusterARN = &f0
